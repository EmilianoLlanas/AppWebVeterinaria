...
<div class="wrapper fadeInDown">
  ...
  <div class="fadeIn first">
    ...
    <s:form action="login" method="POST">
      <s:textfield type="text" id="login" class="fadeIn second"  name="usuario" label="Usuario" placeholder="Usuario"/>
      <s:textfield type="password" id="password" class="fadeIn third" name="password" placeholder="Contaseña"/>
