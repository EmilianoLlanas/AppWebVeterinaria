...
public class PacienteService {
    ...
    public List<Paciente> consultarPacientes() throws SQLException
    {
        ...
        String sql = "SELECT veterinaria.paciente.idPaciente,veterinaria.paciente.nombre,veterinaria.paciente.edad,veterinaria.paciente.categoria  FROM veterinaria.dueno JOIN paciente ON ?=veterinaria.paciente.nombreDueno";
        PreparedStatement ps = conn.prepareStatement(sql);
        ...
        while(rs.next()) {
            ...
            dueno.setNombre(rs.getString("veterinario.dueno.nombre"));
            paciente.setNombre(rs.getString("nombreDueno"));
